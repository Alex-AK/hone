...
export interface ModelReply {
  /**
   * `max_tokens` means the reply hit the completion limit and stopped wherever
   * it had got to. The content is whatever had been written by then, and it is
   * a fragment rather than a short answer: the model was not finished.
   */
...
/**
 * A 429. Nothing was read and nothing was charged, so the conversation you sent
 * is still exactly the conversation to send. `retryAfterMs` is the provider's
 * own number and is not a suggestion.
 */
